...
// SmClient.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CSmClientApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CSmClientApp::OnAppAbout)
...
// CSmClientApp construction

CSmClientApp::CSmClientApp() noexcept
{
	...
	SetAppID(_T("SmClient.AppID.NoVersion"));

	// TODO: add construction code here,
	// Place all significant initialization in InitInstance
}

int CSmClientApp::RegisterOCX(CString strFileName)
{
...
// The one and only CSmClientApp object

CSmClientApp theApp;


// CSmClientApp initialization

BOOL CSmClientApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_SmClientTYPE,
		RUNTIME_CLASS(CSmClientDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CSmClientView));
	if (!pDocTemplate)
		return FALSE;
...
void CSmClientApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CSmClientApp customization load/save methods

void CSmClientApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CSmClientApp::LoadCustomState()
{
}

void CSmClientApp::SaveCustomState()
{
}
